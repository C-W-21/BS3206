...
DELIMITER $$
USE `ims`$$
CREATE PROCEDURE `UpdateVehicle` (cid int, brand varchar(255), model varchar(255), emissions decimal(6,2), occupancy int)
BEGIN
if cid is null
	THEN
...
BEGIN
	INSERT IGNORE INTO vehicles(license_plate, specifications_id)
    VALUES (license, rh);
END$$
